...
class PlaceTestReport(unittest.TestCase):
    ...
    def test_place__city_id(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.city_id, str)
        self.assertTrue(hasattr(first_instance, "city_id"))
    ...
    def test_place__description(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.description, str)
    ...
    def test_place__number_rooms(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.number_rooms, int)
        self.assertTrue(hasattr(first_instance, "number_rooms"))
    ...
    def test_place__number_bathrooms(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.number_bathrooms, int)
        self.assertTrue(hasattr(first_instance, "number_bathrooms"))
    ...
    def test_place__max_guest(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.max_guest, int)
        self.assertTrue(hasattr(first_instance, "max_guest"))
    ...
    def test_place__price_by_night(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.price_by_night, int)
        self.assertTrue(hasattr(first_instance, "price_by_night"))
    ...
    def test_place__latitude(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.latitude, float)
    ...
    def test_place__longitude(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.longitude, float)
    ...
    def test_place__amenity_ids(self):
        ...
        first_instance = Place()
        self.assertIsInstance(first_instance.amenity_ids, list)
        self.assertTrue(hasattr(first_instance, "amenity_ids"))
